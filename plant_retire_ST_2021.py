...
EIA860_active = EIA860_active[isst]
...
EIA923_pjm_st = EIA923_active_pjm[isst]
...
heatrates = EIA923_pjm_st.groupby('Plant Id')[ cols_to_sum].sum().reset_index()
...
EIA923_860_st = EIA860_active.merge(heatrates, left_on='Plant Code',right_on = 'Plant Id', how='inner')
...
X_test = EIA923_860_st[['Heatrate', 'Nameplate Capacity (MW)' ]]
y_pred = rf_model.predict(X_test)
EIA923_860_st["predicted_life"] = y_pred

#look at uprates. 1st, clean up
EIA923_860_st["Planned Uprate Year"] = EIA923_860_st["Planned Uprate Year"].apply(trim_whitespace)
isuprate = EIA923_860_st["Planned Uprate Year"] != ""
#archive original operating date because we're going to over-write them with uprate year
EIA923_860_st["original op yr"] = ''
EIA923_860_st["original op mo"] = ''

EIA923_860_st.loc[isuprate, "original op yr"] = EIA923_860_st.loc[isuprate, 'Operating Year']
EIA923_860_st.loc[isuprate, "original op mo"] = EIA923_860_st.loc[isuprate, 'Operating Month']

#now copy the uprate date into the operating year & mo date
EIA923_860_st.loc[isuprate, 'Operating Year'] = EIA923_860_st.loc[isuprate, 'Planned Uprate Year'] 
EIA923_860_st.loc[isuprate, 'Operating Month'] = EIA923_860_st.loc[isuprate, 'Planned Uprate Month'] 

fl = np.floor(EIA923_860_st["predicted_life"])
EIA923_860_st["proj retire yr"]  = EIA923_860_st['Operating Year'] + fl
EIA923_860_st["proj retire mo"] = EIA923_860_st['Operating Month'] + np.rint(12*(EIA923_860_st["predicted_life"] - fl))

toobig = EIA923_860_st["proj retire mo"] > 12  #more than 12 months no need to adjust
EIA923_860_st.loc[toobig, "proj retire mo"] = EIA923_860_st.loc[toobig, "proj retire mo"] - 12
EIA923_860_st.loc[toobig, "proj retire yr"] = EIA923_860_st.loc[toobig, "proj retire yr"] + 1




EIA923_860_st.to_csv("EIA_proj_retirements_st_noNUC_2021.csv")
